  ...
  if (!hasData) {
    return [
      ...
      },
      {
        page: '/settings',
        title: '标签管理',
        content: '在这里可以新增、修改、删除标签，标签会在视频页的筛选栏中展示。',
        highlight: '[data-tutorial="settings-tags"]',
        position: 'bottom',
        scrollIntoView: true,
      },
      {
      ...
      // 完成
      {
        page: '/settings',
        title: '🎉 搞定！',
        content: '想再次观看指引可以点击「新手引导」，后续有新版本可以通过「检查更新」自动检查并下载。还有很多功能等你慢慢发掘～',
        highlight: '[data-tutorial="settings-about"]',
        position: 'left',
        scrollIntoView: true,
        isLastStep: true,
      },
