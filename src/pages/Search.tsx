...
const Search: React.FC = () => {
  ...
  const getCategoryFeatures = (series: VideoSeries): CategoryFeatures => {
    ...
    return cat ? parseCategoryFeatures(cat.features) : { tags: false, actors: !!series.has_actor, tracking: false, watched: false, status: false, chinese_sub: false, episode: "部" };
  };
